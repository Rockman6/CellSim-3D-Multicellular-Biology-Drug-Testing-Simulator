...
\begin{itemize}
  ...
  \item \code{cellsim\_p53\_pulsing} (Phase G2, new 2026-04-20):
        ...
        Simple 2-variable ODE settles to a stable elevated p53 under
        sustained damage — \emph{not} the Purvis 2012 oscillatory
        regime. True pulsing requires an MDM2-mRNA intermediate
        (Geva-Zatorsky 2006 3-variable model); target of the next PR.
